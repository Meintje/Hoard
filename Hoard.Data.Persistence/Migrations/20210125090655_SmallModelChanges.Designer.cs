...
namespace Hoard.Data.Persistence.Migrations
{
    ...
    [Migration("20210125090655_SmallModelChanges")]
            ...
            modelBuilder.Entity("Hoard.Data.Entities.Game.Playthrough", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PlayDataID = 1,
                            OrdinalNumber = 1,
                            DateEnd = new DateTime(2021, 1, 25, 0, 0, 0, 0, DateTimeKind.Local),
                            DateStart = new DateTime(2021, 1, 25, 0, 0, 0, 0, DateTimeKind.Local),
                            PlayStatusID = 1,
